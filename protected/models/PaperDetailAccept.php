...
class PaperDetailAccept extends PaperDetailAcceptBase {

    public function rules() {
        return array(
            array('paper_id, member_id, car_id, create_at', 'required', 'message' => 'กรุณาเลือก {attribute}'),
    ...
    public function relations() {
        return array(
            ...
            'member' => array(self::BELONGS_TO, 'Personnel', 'member_id'),
        );
    }
